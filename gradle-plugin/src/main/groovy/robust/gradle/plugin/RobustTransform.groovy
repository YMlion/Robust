...
class RobustTransform extends Transform implements Plugin<Project> {
    ...
    void apply(Project target) {
        ...
        if (!isForceInsert) {
            ...
            /*if (null != robust.switch.turnOnRobust &&
                "true" !=
                String.valueOf(robust.switch.turnOnRobust)) {
                return
            }*/
        } else {
            project.android.registerTransform(this)
    ...
    def initConfig() {
        ...
        if (null != robust.switch.filterMethod &&
            "true" ==
            String.valueOf(robust.switch.turnOnHotfixMethod.text())) {
            isHotfixMethodLevel = true
        }

        useASM = !(null != robust.switch.useAsm &&
            "false" ==
            String.valueOf(robust.switch.useAsm.text()))
        ...
        isForceInsert = robust.switch.forceInsert != null &&
            "true" ==
